...
import {
  FormWrapper,
  HierarchyWrapper,
} from "@/modules/Onboarding/Components/CreateOnboarding";
import * as yup from "yup";
import { yupResolver } from "@hookform/resolvers/yup";
import { fileValidation } from "@/modules/OnboardingDetails/Schema";
import { usePOSCreateAndUpdate } from "../service";
import {
  NewTab,
  NewTabsWrapper,
  TabContainer,
...
export const POSSchema = yup.object().shape({
  ...
  pos_code: yup.string().required("POSP Code is required"),
...
const POSBulkForm = () => {
  ...
  const { mutate } = usePOSCreateAndUpdate();
  ...
  return (
    <StyledModal>
      <h1 style={{ margin: "10px 0px" }}> POSP Details</h1>
