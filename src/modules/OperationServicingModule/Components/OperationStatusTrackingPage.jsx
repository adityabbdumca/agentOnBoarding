...
import HistoryModal from "../../Servicing-Module/component/HistoryModal";
import RespondModal from "../../Servicing-Module/component/RespondModal";
import ViewServicingModal from "../../Servicing-Module/component/ViewServicingModal/ViewServicingModal";
import useStatusTracking from "../../Servicing-Module/hooks/useStatusTracking";
import { textColorClasses } from "../../Servicing-Module/servicingModule.constant";
import useGlobalRoutesHandler from "@/hooks/useGlobalHandleRouter";

const OperationStatusTrackingPage = () => {
  const { subRoute } = useGlobalRoutesHandler();
  const isActionableRoute =
    subRoute == "status-tracking-actionable" ? true : false;
  ...
  const [searchData, setSearchData] = useState({
    ...
    search_value: "",
    action_type: isActionableRoute ? "actionable" : "non-actionable",
  });
  ...
  return (
    <div>
      <div className="mb-8 flex flex-col gap-1">
        <h2 className="text-lg font-semibold text-gray-900">
          ...
          <span className="text-primary">
            {" "}
            {isActionableRoute ? "Actionable" : "Non Actionable"}
          </span>
          )
        </h2>
      ...
      <GlobalModal
        ...
        width={600}>
        <HistoryModal historyData={historyData} isLoading={historyEndorsementMutation?.isPending} />
      </GlobalModal>
...
export default OperationStatusTrackingPage;
